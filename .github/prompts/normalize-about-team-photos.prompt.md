---
description: "Normalize A&B Construction About page team headshots so employee photos are consistently centered, cropped, named, and displayed."
---

You are cleaning up the A&B Construction About page team photos.
...
Inspect `src/pages/about.astro`, any team image folder inside `public/`, and available source headshots. Then update the About page and photo usage so employee images feel consistent across the team grid.

Requirements:

- Confirm each employee listed on the About page has a matching image file in the team image folder.
