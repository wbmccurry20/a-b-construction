      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="text-gray-300 hover:text-construction-primary transition-colors"
                aria-label="Facebook"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="text-gray-300">Green Building</li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-sm text-gray-300">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <a href="/sitemap" className="hover:text-construction-primary transition-colors">
              Sitemap
            </a>
          </div>
        </div>
